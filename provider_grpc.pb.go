...
type ProviderClient interface {
	LisProject(ctx context.Context, in *ListProjectRequest, opts ...grpc.CallOption) (*ListProjectResponse, error)
...
func (c *providerClient) LisProject(ctx context.Context, in *ListProjectRequest, opts ...grpc.CallOption) (*ListProjectResponse, error) {
	out := new(ListProjectResponse)
	err := c.cc.Invoke(ctx, "/Provider/LisProject", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ProviderServer interface {
	LisProject(context.Context, *ListProjectRequest) (*ListProjectResponse, error)
...
func (UnimplementedProviderServer) LisProject(context.Context, *ListProjectRequest) (*ListProjectResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method LisProject not implemented")
}
...
func _Provider_LisProject_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListProjectRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ProviderServer).LisProject(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Provider/LisProject",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProviderServer).LisProject(ctx, req.(*ListProjectRequest))
	}
...
var Provider_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "LisProject",
			Handler:    _Provider_LisProject_Handler,
		},
		{
